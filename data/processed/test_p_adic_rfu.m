...
clc;close all;
filename = '/Users/rowanbrown/Documents/GitHub/UP1_Environmental_Noise_Cancellation/data/processed/rugby_analysis_ready.csv';
...
rugby_league = create_rugby_sports_data(aggregated_data, prime)
...
rugby_analysis_results = analyze_rugby_padic(rugby_league)
...
run_complete_rugby_analysis(csv_filename)
